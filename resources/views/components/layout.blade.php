...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="pl-5 mt-3 pr-5">
        {{-- Content của trang đó --}}
        {{-- Header của trang --}}
        <x-header/>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0&appId=153638581946489&autoLogAppEvents=1" nonce="UTNfFpTI"></script>
